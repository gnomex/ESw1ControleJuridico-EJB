 ...
 * 
 */
@WebServiceClient(name = "ClienteWS", targetNamespace = "http://cliente.ws.juridico.controle.unioeste.br/", wsdlLocation = "http://localhost:8080/ClienteWS/ClienteWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTEWS_QNAME = new QName("http://cliente.ws.juridico.controle.unioeste.br/", "ClienteWS");
    ...
    public ClienteWS getClienteWSPort() {
        return super.getPort(new QName("http://cliente.ws.juridico.controle.unioeste.br/", "ClienteWSPort"), ClienteWS.class);
    }
    ...
    public ClienteWS getClienteWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cliente.ws.juridico.controle.unioeste.br/", "ClienteWSPort"), ClienteWS.class, features);
    }
